...
import { fetchCategories, fetchTransactions, fetchAccounts } from '../../services/database';
...
export const setTransactionsListData = createAction('TRANSACTIONS_LIST/SET_TRANSACTIONS_LIST_DATA');

export const fetchTransactionsListDataStart = createAction('TRANSACTIONS_LIST/SET_TRANSACTIONS_LIST_DATA_START');
export const fetchTransactionsListDataFailure = createAction('TRANSACTIONS_LIST/SET_TRANSACTIONS_LIST_DATA_FAILURE');
...
export const fetchTransactionsListData = () => async dispatch => {
  ...
  try {
    ...
    dispatch(setTransactionsListData({ accounts, categories, transactions }));
  } catch(e) {
    dispatch(fetchTransactionsListDataFailure());
  }
};
