...
export const getTransactionsGroupedByCategories = ({
  ...
  const transactionsList = getTransactionsList(byId, categoriesById, accountsById);
...
export const getTransactionsChartData = ({
  ...
  const incomeTransactions = filterTransactionsByCategoryType(transactions, categoriesById, categoryTypes.INCOME_CATEGORY);
  const outcomeTransactions = filterTransactionsByCategoryType(transactions, categoriesById, categoryTypes.OUTCOME_CATEGORY);
